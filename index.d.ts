...
declare function alpha(config?: { key: string }): {
    util: {
    ...
    data: {
        ...
        daily_adjusted: (symbol: string, outputsize?: string, datatype?: string, interval?: string) => Promise<RawStockDailyAdjusted>;
        ...
        monthly_adjusted: <T = any>(symbol: string, outputsize?: string, datatype?: string, interval?: string) => Promise<T>;
    ...
    technical: {
        ...
        mama: <T = any>(symbol: string, interval: string, series_type: string, fastlimit: number, slowlimit: number) => Promise<T>;
        t3: <T = any>(symbol: string, interval: string, time_period: any, series_type: string) => Promise<T>;
        macd: <T = any>(symbol: string, interval: string, series_type: string, fastperiod: number, slowperiod: number, signalperiod: number, fastmatype: any, slowmatype: any, signalmatype: any) => Promise<T>;
        macdext: <T = any>(symbol: string, interval: string, series_type: string, fastperiod: number, slowperiod: number, signalperiod: number, fastmatype: any, slowmatype: any, signalmatype: any) => Promise<T>;
        stoch: <T = any>(symbol: string, interval: string, fastkperiod: any, slowkperiod: any, slowdperiod: any, slowkmatype: any, slowdmatype: any) => Promise<T>;
        stochf: <T = any>(symbol: string, interval: string, fastkperiod: any, fastdperiod: any, fastdmatype: any) => Promise<T>;
        rsi: <T = any>(symbol: string, interval: string, time_period: any, series_type: string) => Promise<T>;
        stochrsi: <T = any>(symbol: string, interval: string, time_period: any, series_type: any, fastkperiod: any, fastdperiod: any, fastdmatype: any) => Promise<T>;
        ...
        apo: <T = any>(symbol: string, interval: string, series_type: string, fastperiod: any, slowperiod: any, matype: any) => Promise<T>;
        ppo: <T = any>(symbol: string, interval: string, series_type: string, fastperiod: any, slowperiod: number, matype: any) => Promise<T>;
        ...
        ultosc: <T = any>(symbol: string, interval: string, timeperiod1: string, timeperiod2: any, timeperiod3: any) => Promise<T>;
        ...
        bbands: <T = any>(symbol: string, interval: string, time_period: any, series_type: string, nbdevup: any, nbdevdn: any, matype: any) => Promise<T>;
