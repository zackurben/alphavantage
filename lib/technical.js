...
module.exports = config => {
  ...
  return {
    ...
    t3: SMA_LIKE('T3'),
    macd: (symbol, interval, series_type, fastperiod = 12, slowperiod = 26, signalperiod = 9) =>
      util.fn('MACD')({ symbol, interval, series_type, fastperiod, slowperiod, signalperiod }),
    rsi: SMA_LIKE('RSI'),
    mom: SMA_LIKE('MOM'),
    cmo: SMA_LIKE('CMO'),
    roc: SMA_LIKE('ROC'),
